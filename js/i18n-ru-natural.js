...
latinSubst('Jaguar', "Ягуар");
latinSubst('Java', "Джава");
latinSubst('JavaScript', 'Джава скрипт');
...
latinSubst('Ubuntu', 'Убунту');
latinSubst('YouTube', 'Ютуб');
latinSubst('USB', 'юэсб+и');
latinSubst('UTair', 'Ютэйр');
latinSubst('vr', 'ви+ар');
