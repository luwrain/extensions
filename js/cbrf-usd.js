...
Luwrain.addCommand("currency-usd", function(){Luwrain.runBkg(function(){
...
Luwrain.addCommand("currency-eur", function(){Luwrain.runBkg(function(){
    var date = new java.util.Date();
    var day = date.getDate();
    day = day < 10?"0" + day:"" + day;
    var month = date.getMonth() + 1;
